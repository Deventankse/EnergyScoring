...
<html lang="en">
   <head>
      ...
      <title>Test Spring MVC and Security - ${userRole} &amp; ${pageName}</title>
   ...
   <body>
      ...
      <div class="row-fluid">
         <div class="col-xs-12">
            <ol class="breadcrumb">
               <li>
                  <h4><img alt="Brand" src="${pageContext.request.contextPath}/assets/images/testicon.png" width="24" height="24">&nbsp;Sample Spring App</h4>
               </li>
            </ol>
         </div>
      </div>
